...
export const metadata: Metadata = {
  title: "Bakteria | Premium Cups & Drinkware",  description: "Discover Bakteria's collection of premium cups and drinkware. High-quality ceramic, thermal, and glass cups for coffee, tea, and beverage lovers.",  keywords: "premium cups, ceramic cups, thermal cups, drinkware, coffee cups, tea cups, high-quality cups",  metadataBase: new URL('http://img.b2bpic.net'),
  alternates: {
    canonical: 'http://img.b2bpic.net'
  },
  openGraph: {
    title: "Bakteria | Premium Cups & Drinkware",    description: "Discover Bakteria's collection of premium cups and drinkware. High-quality ceramic, thermal, and glass cups for coffee, tea, and beverage lovers.",    siteName: "Bakteria",    type: "website",    images: [{
      url: "http://img.b2bpic.net/free-photo/closeup-decorated-cocktail-summer-drink_53876-95376.jpg",      alt: "Bakteria premium cups collection"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Bakteria | Premium Cups & Drinkware",    description: "Discover our premium cup collection. High-quality drinkware for coffee and tea lovers.",    images: ["http://img.b2bpic.net/free-photo/closeup-decorated-cocktail-summer-drink_53876-95376.jpg"]
  },
  robots: {
    index: true,
    follow: true
